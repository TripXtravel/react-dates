...
var propTypes = (0, _airbnbPropTypes.forbidExtraProps)({
  ...
  isDayFlexible: _propTypes["default"].func,
...
var defaultProps = {
  ...
  isDayFlexible: function isDayFlexible() {},
...
function (_ref) {
  ...
  function DayPickerRangeController(props) {
    ...
    _this.modifiers = {
      ...
      'flexible-calendar': function flexibleCalendar(day) {
        return props.isDayFlexible(day);
      },
  ...
  _createClass(DayPickerRangeController, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      var startDate = nextProps.startDate,
          ...
          isDayFlexible = nextProps.isDayFlexible,
      ...
      var _this$props = this.props,
          ...
          prevIsDayFlexible = _this$props.isDayFlexible,
      ...
      var recomputeDayFlexible = false;
      ...
      if (isDayFlexible !== prevIsDayFlexible) {
        this.modifiers['flexible-calendar'] = function (day) {
          return isDayFlexible(day);
        };

        recomputeDayFlexible = true;
      }

      var recomputePropModifiers = recomputeOutsideRange || recomputeDayBlocked || recomputeDayHighlighted || recomputeDayFlexible;
          ...
          Object.keys(days).forEach(function (day) {
            ...
            if (didFocusChange || recomputeDayFlexible) {
              if (isDayFlexible(momentObj)) {
                modifiers = _this2.addModifier(modifiers, momentObj, 'flexible-calendar');
              } else {
                modifiers = _this2.deleteModifier(modifiers, momentObj, 'flexible-calendar');
              }
            }
          });
        });
